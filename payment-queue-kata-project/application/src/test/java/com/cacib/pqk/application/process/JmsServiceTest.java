...
class JmsServiceTest {
    ...
    void shouldExtractMessageSuccessfully() throws Exception {
        ...
        assertEquals(MessageStatus.PROCESSED, result.getStatus());
    ...
    void shouldCreateErroredMessageFromTextMessage() throws Exception {
        ...
        assertThat(result.getMetadata()).contains("ID123");
        assertThat(result.getMetadata()).contains("Simulated error");
        assertThat(result.getMetadata()).contains("DEV.QUEUE.1");
    }
