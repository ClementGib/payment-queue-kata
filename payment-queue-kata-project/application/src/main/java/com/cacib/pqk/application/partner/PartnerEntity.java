...
import com.cacib.pqk.application.partner.direction.DirectionConverter;
import com.cacib.pqk.application.partner.flow.FlowTypeConverter;
...
@Entity
@Table(schema = "pqkapp", name = "partner")
@Getter
@Setter
